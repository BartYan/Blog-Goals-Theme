...
<section class="cards_section">
  <div class="section_title">
    <span class="section_title-span">Nasza</span>
    <h2 class="section_title-head">Polityka Prywatności</h2>
    <img class="section_title-stars" src="<?php echo get_stylesheet_directory_uri() ?>/img/svg/icon_stars.svg"
      alt="ikonka gwiazdek">
  </div>

  <div class="text_center">
    <h4 class="text_center-head">
      I Informacje ogólne
    </h4>
    ...
    <p class="text_center-p">
    • Właścicielami stron internetowych wyprawiamdobre.pl i tastewithit.com oraz administratorami danych osobowych są Bartosz Janusz i Julia Pasternak zamieszkali w Krakowie ul. Mackiewicza 25, 31-214 Kraków.
    <!-- prowadzący działalność gospodarczą pod .., z siedzibą w .. , ul. .. , NIP .., REGON: .., wpisany do Centralnej Ewidencji i Informacji o Działalności Gospodarczej Rzeczypospolitej Polskiej. -->
    </p>
    <h4 class="text_center-head">
    II Dane osobowe
    </h4>
    ...
    <br/>• Dane osobowe są pozyskiwane podczas wypełniania formularza newsletter
    <br/>• Dane osobowe są wykorzystywane wyłącznie w celu wysyłania newslettera oraz o ile użytkownik wyraził na to zgodę.
    <br/>• Zawartość strony internetowej można przeglądać bez podawania jakichkolwiek danych osobowych.
    <br/>• Każda osoba, która udostępniła swoje dane osobowe ma prawo do dostępu do ich treści oraz możliwość ich poprawiania, uaktualniania, uzupełniania, jak i również żądania zaprzestania przetwarzania danych osobowych oraz wniesienia sprzeciwu wobec przetwarzania danych osobowych. Wymienione czynności można dokonać poprzez wysłanie stosownego oświadczenia na adres email: kontakt@wyprawiamdobre.pl
    ...
    <br/> – szyfrowanie danych służących do zapisu do newslettera
    <br/>– zabezpieczenie zbioru danych przed nieuprawnionym dostępem
    </p>
    <h4 class="text_center-head">
    ...
    <br/>• Zalecamy przeczytanie polityki ochrony prywatności tych firm, aby poznać zasady korzystania z plików cookies wykorzystywane w statystykach: 
    <a href="https://policies.google.com/privacy?hl=pl" target="_blank"> Polityka ochrony prywatności Google i Google Analytics.</a>
    ...
    <br/>• W zakresie informacji o preferencjach użytkownika gromadzonych przez sieć reklamową Google użytkownik może przeglądać i edytować informacje wynikające z plików cookies przy pomocy narzędzia: <a href="https://www.google.com/ads/preferences/" target="_blank"> https://www.google.com/ads/preferences/</a>
    </p>
    <h4 class="text_center-head">
    ...
    <p class="text_center-p">
    <br/>• Dane podlegają udostępnieniu podmiotom zewnętrznym wyłącznie w granicach prawnie dozwolonych.
    ...
    <p class="text_center-p">
    • Administrator ma prawo do zmian w niniejszej Polityce Prywatności. Osoby udostępniające swoje dane osobowe obowiązuje aktualnie obowiązująca wersja Polityki Prywatności, dostępna na stronie https://wyprawiamdobre.pl/polityka-prywatnosci/
